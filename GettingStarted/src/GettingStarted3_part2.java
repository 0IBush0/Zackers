...
public class GettingStarted3_part2 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        boolean buttonstale = false;//create boolean variable
        ...
        while(true){
            ...
            if(redButton.getState() && !buttonstale){//swap for opposite results
                redLED.setState(true);//swap for opposite results
            } else {
                redLED.setState(false);//swap for opposite results
            }

            if(greenButton.getState() && !buttonstale){//swap for opposite results, change to !buttonstale for count
                greenLED.setState(true);//swap for opposite results
            } else {
                greenLED.setState(false);//swap for opposite results
            }
