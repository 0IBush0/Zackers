...
public class GettingStarted2 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        greenButton.setHubPort(5);//0 is the red button, 5 is the green button
        ...
        while(true)
        {
        	...
        	if(greenButton.getState() && !buttonstale)//only send message when pressed
        	{
        		System.out.println("Button State: " + greenButton.getState());
        		Thread.sleep(300);//time per mil seconds.
